/**
 * ElementUI Adapter 预设
 * 符合 @form-renderer/adapter-vue2 规范的组件预设
 */

import { getDefaultTransformer } from './value-transformers'
import { getDefaultEventMapping } from './event-mapping'
import { convertToElementUIRules } from './validation'
 ...
 * 所有组件定义
 */
const allComponents = [...fieldComponents, ...containerComponents]

/**
 * ElementUI 预设
 */
export const ElementUIPreset = {
  name: '@form-renderer/preset-element-ui',
  components: allComponents,
  setup: async () => {
    // 预设初始化逻辑
    // console.log('ElementUI preset initialized')
  },
  formItem: FieldWrapper,
  ruleConverter: convertToElementUIRules
}

/**
 * 创建 ElementUI 预设的工厂函数
 */
// eslint-disable-next-line no-unused-vars
export function createElementUIPreset(options) {
  return {
    ...ElementUIPreset,
    ruleConverter: convertToElementUIRules
  }
...
export default ElementUIPreset
